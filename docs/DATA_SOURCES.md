...
- **US Census quarterly** — ✅ WIRED + POPULATED. Monthly -> complete quarters; overrides Comtrade for
  the US. Live in the DB: US coffee annual 2025 $12.63B (source=census), Q 2026-Q1 $3.21B.
- **Korea KCS** — ✅ WIRED. `nitemtrade` service approved on data.go.kr; `KcsSource` (reporter 410),
  quarterly + annual, **fresh to 2026-Q2**, overrides Comtrade for Korea via merge authority. Values
  USD (verified). Query capped ~12 months -> chunked per calendar year. Live: KR coffee 2025 $1.70B.
